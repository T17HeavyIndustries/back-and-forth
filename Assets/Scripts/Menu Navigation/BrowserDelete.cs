...
public class BrowserDelete : MonoBehaviour {
    ...
    void Down() {
        if (CustomLevelMain.CurLevelInfo != null) {
            File.Delete(Application.persistentDataPath + "/" + CustomLevelMain.CurLevelInfo.filePath);
            Main.RemoveTimeCustom(CustomLevelMain.CurLevelInfo.name);
